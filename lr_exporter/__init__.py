...
from .operators.operators import OBJECT_OT_lr_hierarchy_exporter, OBJECT_OT_store_object_data_json,OBJECT_OT_lr_pivot_painter_export
...
classes = [lr_export_settings,OBJECT_OT_lr_hierarchy_exporter,VIEW3D_PT_lr_export_setup,VIEW3D_PT_lr_export, VIEW3D_PT_lr_export_assembly, OBJECT_OT_store_object_data_json,OBJECT_OT_lr_pivot_painter_export]
